...
public class CitiJuarez extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_citi_juarez);
        edtType=findViewById(R.id.edtType);
        edtService=findViewById(R.id.edtService);
        edtMoney=findViewById(R.id.edtMoney);

        FirebaseFirestore db= FirebaseFirestore.getInstance();
        db.collection("citibanamex").document("Av. Juarez").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
    ...
    private void locationBank() {
        ...
        intent.putExtra("Banco","BanamexJuarez");
    ...
    private void updateData(){
        ...
        String collection="citibanamex";
        FirebaseFirestore dbUpdate= FirebaseFirestore.getInstance();
        dbUpdate.collection(collection).document("Av. Juarez")
            .update("Dinero",money);
