...
public class San14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_san14);
        edtType=findViewById(R.id.edtType);
        edtService=findViewById(R.id.edtService);
        edtMoney=findViewById(R.id.edtMoney);

        FirebaseFirestore db= FirebaseFirestore.getInstance();
        db.collection("santander").document("14 oriente").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
    ...
    private void locationBank() {
        ...
        intent.putExtra("Banco","Santander14");
