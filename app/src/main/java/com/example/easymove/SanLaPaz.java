...
public class SanLaPaz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_san_la_paz);
        edtType=findViewById(R.id.edtType);
        edtService=findViewById(R.id.edtService);
        edtMoney=findViewById(R.id.edtMoney);

        FirebaseFirestore db= FirebaseFirestore.getInstance();
        db.collection("santander").document("La Paz").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
    ...
    private void updateData(){
        ...
        dbUpdate.collection(collection).document("La Paz")
            .update("Dinero",money);
