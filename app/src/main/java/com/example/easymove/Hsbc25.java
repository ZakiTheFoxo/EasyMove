...
public class Hsbc25 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hsbc25);
        edtType=findViewById(R.id.edtType);
        edtService=findViewById(R.id.edtService);
        edtMoney=findViewById(R.id.edtMoney);

        FirebaseFirestore db= FirebaseFirestore.getInstance();
        db.collection("hsbc").document("25 poniente").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
    ...
    private void updateData(){
        ...
        dbUpdate.collection(collection).document("25 poniente")
            .update("Dinero",money);
