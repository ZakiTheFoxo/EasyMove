...
public class SanUpa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_san_upa);
        edtType=findViewById(R.id.edtType);
        edtService=findViewById(R.id.edtService);
        edtMoney=findViewById(R.id.edtMoney);

        FirebaseFirestore db= FirebaseFirestore.getInstance();
        db.collection("santander").document("UPAEP").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if(documentSnapshot.exists()){
                    txtType=findViewById(R.id.txtType);
                    txtType.setText(documentSnapshot.getString("Tipo de cajero").toString());
    ...
    private void locationBank() {
        ...
        intent.putExtra("Banco","SantanderPaz");
    ...
    private void updateData(){
        ...
        dbUpdate.collection(collection).document("UPAEP")
                .update("Dinero",money);
