...
public class SanReforma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_san_reforma);
        edtType=findViewById(R.id.edtType);
        edtService=findViewById(R.id.edtService);
        edtMoney=findViewById(R.id.edtMoney);

        FirebaseFirestore db= FirebaseFirestore.getInstance();
        db.collection("santander").document("reforma").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if(documentSnapshot.exists()){
                    ...
                    txtService.setText(documentSnapshot.getString("Fuera de serivicio").toString());
    ...
    private void locationBank() {
        ...
        intent.putExtra("Banco","SantanderReforma");
    ...
    private void updateData(){
        ...
        String collection="santander";
        FirebaseFirestore dbUpdate= FirebaseFirestore.getInstance();
        dbUpdate.collection(collection).document("reforma")
            .update("Dinero",money);

        dbUpdate.collection(collection).document("reforma")
            .update("Fuera de serivicio",service);
